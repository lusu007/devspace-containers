...
curl -s "https://api.github.com/repos/loft-sh/devspace/releases/$DEVSPACE_VERSION" | grep "browser_download_url.*devspace-linux-$ARCH_SHORT" | cut -d : -f 2,3 | tr -d \" | grep -v '.sha256' | wget -O devspace -qi -
chmod +x devspace
